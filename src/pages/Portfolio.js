      ...
      <div className='container mx-auto h-full relative'>
        <div className='flex flex-col lg:flex-row h-full items-center justify-start gap-x-24 text-center lg:text-left pt-24 lg:pt-36 pb-8'>
          ...
          >
            ...
            Ob <b>Portraits, sinnliche Momente, Paar- oder Babyshootings</b> – ich liebe es, die Einzigartigkeit jedes Augenblicks einzufangen. 
            <br />
            <br />
            Mein Portfolio zeigt, wie vielseitig und kreativ meine Arbeit ist. Stöbere durch meine Bilder und lass uns dein nächstes Projekt gemeinsam angehen. 
            <br />
            <br />Ich freue mich darauf, etwas Neues mit dir zu schaffen und zu erleben!
            </p>
